...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * jQuery is automatically loaded because most of plugins need it globaly (see in webpack.config.js)
	 */
	...
	var _componentsWindow = __webpack_require__(40);
	
	var _componentsWindow2 = _interopRequireDefault(_componentsWindow);
	
	var _viewsApp = __webpack_require__(55);
	...
	$(function () {
	  // Init Window
	  window.W = new _componentsWindow2['default']();
	
	  // Init App
	  window.app = new _viewsApp2['default']();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! formstone v1.0.1 [core.js] 2016-03-25 | MIT License | formstone.it */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! formstone v1.0.1 [mediaquery.js] 2016-03-25 | MIT License | formstone.it */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$setPrototypeOf = __webpack_require__(61)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashUniqueid = __webpack_require__(97);
	...
	var BaseView = (function () {
	  function BaseView() {
	    ...
	    this._el = null;
	    this.cid = (0, _lodashUniqueid2['default'])();
	  ...
	  _createClass(BaseView, [{
	    ...
	    value: function setElement(element) {
	      ...
	      // `this.el` property.
	      this.$el = element instanceof _jquery2['default'] ? element : (0, _jquery2['default'])(element);
	      this._el = this.$el[0];
	    ...
	    value: function _ensureElement() {
	      if (!this._el) {
	        var attrs = _Object$assign({}, this.attributes);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventEmitter = (function () {
	  ...
	  // Bind an event to a `listner` function. Passing `"all"` will bind
	  ...
	  _createClass(EventEmitter, [{
	    ...
	    value: function on(type, listener) {
	      ...
	      if (listeners.length > this._maxListeners) {
	        console.error("Possible memory leak, added %i %s listeners, use EventEmitter#setMaxListeners(number) if you want to increase the limit (%i now)", listeners.length, type, this._maxListeners);
	      }
	    ...
	    value: function trigger(type) {
	      ...
	      var listeners = this._events[type];
	      var allListeners = this._events.all;
	      ...
	      if (allListeners && allListeners.length) {
	        allListeners.forEach(function (fn) {
	          return fn.apply(null, args);
	        });
	      }
	...
	var Window = (function () {
	  ...
	  _createClass(Window, [{
	    ...
	    value: function onEnterFrame() {
	      ...
	      this.isResizing = width != this.width || height != this.height;
	      this.isScrolling = scrollTop != this.scrollTop || scrollLeft != this.scrollLeft;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Accordion = (function () {
	  function Accordion() {
	    ...
	    this.$accordion = $(defaults.accordion);
	  ...
	  _createClass(Accordion, [{
	    ...
	    value: function initEvents() {
	      this.$items.on('click', this.triggerClicked.bind(this));
	    }
	  }, {
	    key: 'triggerClicked',
	    value: function triggerClicked(event) {
	      var $currentAccordion = $(event.currentTarget);
	
	      if ($(event.target).hasClass(defaults.triggerClass)) {
	        this.closeOthers($currentAccordion);
	        $currentAccordion.toggleClass(defaults.open);
	      }
	    }
	  }, {
	    key: 'closeOthers',
	    value: function closeOthers(accordion) {
	      this.$items.not(accordion).removeClass(defaults.open);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getIterator = __webpack_require__(57)['default'];
	...
	var AnimateScroll = (function () {
	  function AnimateScroll(element) {
	    ...
	    // Write variables
	    this.els = document.querySelectorAll('*[data-animate-scroll]');
	    this.loop = null;
	  ...
	  _createClass(AnimateScroll, [{
	    ...
	    value: function update() {
	      ...
	      try {
	        for (var _iterator = _getIterator(this.els), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          var el = _step.value;
	
	          var options = el.getAttribute('data-animate-scroll');
	          var args = {};
	          ...
	          // Merge arguments
	          _Object$assign(args, DEFAULTS, options);
	          ...
	          // Apply animation or not
	          var _scrollY = window.pageYOffset || document.documentElement.scrollTop;
	          var posY = el.offsetTop;
	
	          // Update el with specific container
	          if (trigger) {
	            var $trigger = document.querySelector(trigger);
	            // Change posY
	            posY = $trigger.offsetTop;
	          }
	
	          var calc = posY - window.innerHeight / 100 * (100 - offset);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chosenChosenJqueryJs = __webpack_require__(33);
	
	var _chosenChosenJqueryJs2 = _interopRequireDefault(_chosenChosenJqueryJs);
	
	var _chosenChosenJqueryJs3 = _interopRequireDefault(_chosenChosenJqueryJs);
	
	var defaults = {
	  item: '.js-dropdown',
	  dataSubmitOnChange: 'submit-on-change',
	  dataWidthAuto: 'width-auto'
	};
	...
	var CustomDropdown = (function () {
	  ...
	  _createClass(CustomDropdown, [{
	    ...
	    value: function init() {
	      ...
	      $(defaults.item).each(function (i, item) {
	        var $item = $(item);
	        var chosenOptions = {
	        ...
	        if ($item.is('[data-' + defaults.dataWidthAuto + ']')) {
	          chosenOptions.width = 'auto';
	        }
	
	        $item.chosen(chosenOptions);
	        // detect mobile because chosen doesnt run on mobile
	        if (!$item.next().hasClass('js-dropdown')) {
	          $item.after('<i class="icon-arrow-down"></i>');
	        }
	
	        if ($item.is('[data-' + defaults.dataSubmitOnChange + ']')) {
	          $item.on('change', _this.submitOnChange.bind(_this, $item));
	        }
	      });
	    }
	  }, {
	    key: 'submitOnChange',
	    value: function submitOnChange($select, event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Focus = (function () {
	  function Focus() {
	    ...
	    $(defaults.selector).each(function (i, item) {
	      var $item = $(item);
	      console.log($item);
	      if ($item.find('input, select, textarea').length) {
	        $item.on('focusin', 'input, select, textarea', _this.focusIn.bind(_this));
	        $item.on('focusout', 'input, select, textarea', _this.focusOut.bind(_this));
	      }
	    });
	  }
	  ...
	  _createClass(Focus, [{
	    ...
	    value: function focusIn(event) {
	      $(event.delegateTarget).addClass(defaults.focused);
	    }
	  }, {
	    key: 'focusOut',
	    value: function focusOut(event) {
	      $(event.delegateTarget).removeClass(defaults.focused);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashDebounce = __webpack_require__(95);
	
	var _lodashDebounce2 = _interopRequireDefault(_lodashDebounce);
	
	var defaults = {
	  tallestItem: 'graph__item--tallest'
	};
	...
	var Graph = (function () {
	  ...
	  _createClass(Graph, [{
	    key: 'init',
	    value: function init() {
	      this.targetHeight = 110;
	      this.tallestHeight = 140;
	      this.minTranslate = 100;
	
	      this.graph();
	
	      $(window).resize((0, _lodashDebounce2['default'])(this.windowResized.bind(this), 300));
	    }
	  }, {
	    key: 'graph',
	    value: function graph() {
	      ...
	      this.$graph.html('');
	      this.frag = "";
	      this.bars = this.getOddNumberOfBars(this.spacing, window.W.width);
	      // available easing functions: linear, quadratic, cubic, quartic, quintic, sinusoidal, circular, exponential
	      this.easings = (0, _easing2['default'])(this.bars, 'cubic', { endToEnd: true });
	      this.centerBarIndex = Math.floor(this.bars / 2);
	
	      this.xOffset = 0;
	      this.appliableTranslates = [];
	      this.$items = [];
	
	      var translates = this.easings.map(function (value, index, array) {
	        var translate = Math.min(_this.minTranslate, _this.targetHeight - _this.targetHeight * value);
	        // build a collection containing only the transform values that are smaller than the minimum translate
	        if (translate < _this.minTranslate) {
	          _this.appliableTranslates.push({
	            index: index,
	            translate: translate
	          });
	        }
	        // build a collection containing all the translate values for the graph items
	        return Math.min(_this.minTranslate, _this.targetHeight - _this.targetHeight * value);
	      });
	
	      translates.map(function (value, index, array) {
	        var itemHeight = value;
	        var itemSpacing = _this.spacing - 1;
	        var itemClass = '';
	
	        if (index === _this.centerBarIndex) {
	          itemHeight = _this.tallestHeight;
	          itemClass = defaults.tallestItem;
	          _this.frag += '<div class=\'graph__item ' + index + ' ' + itemClass + '\' style="margin-right:' + itemSpacing + 'px;"></div>';
	        } else {
	          _this.frag += '<div class=\'graph__item ' + index + ' ' + itemClass + '\' style="transform:translateY(' + itemHeight + 'px);margin-right:' + itemSpacing + 'px;"></div>';
	        }
	      });
	      ...
	      this.$graph.html(this.frag);
	      $('.graph__item').each(function (i, item) {
	    ...
	    value: function shiftLeft() {
	      var additionalItem = $('<div class=\'graph__item graph__item-new\' style="transform: translateY(100px);margin-right:' + (this.spacing - 1) + 'px;"></div>');
	      this.xOffset--;
	
	      // slide the whole graph left
	      this.slide();
	
	      // apply new translates
	      this.applyTranslations();
	
	      // add an item to the graph and the items collection
	      this.$graph.append(additionalItem);
	      this.$items.push(additionalItem);
	
	      // remove tallest class
	      this.$graph.find(':nth-child(' + (this.centerBarIndex - this.xOffset) + ')').removeClass(defaults.tallestItem);
	      // add tallest class
	      this.$graph.find(':nth-child(' + (this.centerBarIndex - this.xOffset + 1) + ')').addClass(defaults.tallestItem);
	    }
	  }, {
	    key: 'shiftRight',
	    value: function shiftRight() {
	      ...
	      // remove tallest class
	      this.$graph.find(':nth-child(' + (this.centerBarIndex - this.xOffset + 2) + ')').removeClass(defaults.tallestItem);
	      // add tallest class
	      this.$graph.find(':nth-child(' + (this.centerBarIndex - this.xOffset + 1) + ')').addClass(defaults.tallestItem);
	    }
	  }, {
	    ...
	    value: function slide() {
	      // slide the whole graph left
	      this.$graph.css({
	        "transform": 'translateX(' + this.xOffset * this.spacing + 'px)'
	      });
	    }
	  }, {
	    ...
	    value: function applyTranslations() {
	      ...
	      this.appliableTranslates.forEach(function (value, index, array) {
	        _this2.$items[value.index - _this2.xOffset].css({
	          "transform": 'translateY(' + value.translate + 'px)'
	        });
	      });
	    }
	  }, {
	    ...
	    key: 'getOddNumberOfBars',
	    value: function getOddNumberOfBars(spacing, width) {
	      var bars = Math.floor(width / spacing);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formstoneDistJsCarousel = __webpack_require__(17);
	
	var _formstoneDistJsCarousel2 = _interopRequireDefault(_formstoneDistJsCarousel);
	...
	var HeroSlider = (function () {
	  function HeroSlider(options) {
	    ...
	    this.$nodes = this.$slider.find(defaults.nodes);
	    this.$dots = this.$slider.find(defaults.dots);
	    ...
	    // Reassign options
	    _Object$assign(this.options = {}, defaults, options);
	  ...
	  _createClass(HeroSlider, [{
	    ...
	    value: function events() {
	      ...
	      this.$dots.on('click', function (event) {
	        ...
	        if (!_this.isChanging && !$el.hasClass('is-active')) {
	          _this.jump(n);
	        }
	      });
	    }
	    ...
	    value: function jump(n) {
	      ...
	      var el = this.$nodes.eq(n);
	      var $el = $(el);
	      var $prev = this.$nodes.filter('.is-visible');
	      ...
	      // Hide previous
	      $prev.removeClass('is-visible').addClass('is-hidden');
	      ...
	      // Activate
	      this.$dots.eq(n).addClass('is-active');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formstoneDistJsLightbox = __webpack_require__(19);
	
	var _formstoneDistJsLightbox2 = _interopRequireDefault(_formstoneDistJsLightbox);
	
	var defaults = {
	  lightbox: '.js-media-lightbox'
	};
	
	var MediaLightbox = function MediaLightbox() {
	  _classCallCheck(this, MediaLightbox);
	
	  this.$lightbox = $(defaults.lightbox);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaults = {
	  item: '.js-password-protected',
	  form: '.js-password-protected-form',
	  message: '.js-password-protected-message',
	  hiddenMessage: 'alert--hide',
	  contactFormLink: '.js-contact-form-link'
	};
	
	var PasswordProtected = (function () {
	  function PasswordProtected() {
	    _classCallCheck(this, PasswordProtected);
	
	    this.$items = $(defaults.item);
	    this.$form = $(defaults.form);
	    this.$password = this.$form.find('input[name=password]');
	    this.$action = this.$form.find('input[name=action]');
	    this.$message = $(defaults.message);
	    this.$contactFormLink = $(defaults.contactFormLink);
	
	    this.$form.on('submit', this.onSubmit.bind(this));
	    this.$password.on('change', this.onSubmit.bind(this));
	    this.$contactFormLink.on('click', this.contactFormLinkClicked.bind(this));
	
	    this.$items.lightbox();
	  }
	
	  _createClass(PasswordProtected, [{
	    key: 'onSubmit',
	    ...
	    value: function hideError() {
	      this.$message.parent().toggleClass(defaults.hiddenMessage);
	    }
	  }, {
	    key: 'displayError',
	    ...
	    value: function sendForm() {
	      ...
	      $.post(this.$action.val(), this.$form.serialize(), function (result) {
	        if (result.error) {
	          _this.displayError(result.error);
	        } else {
	    ...
	    key: 'contactFormLinkClicked',
	    value: function contactFormLinkClicked(event) {}
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Popup = (function () {
	  function Popup() {
	    ...
	    this.$nodes = (0, _jquery2['default'])('[data-popup-link]');
	    this.$body = (0, _jquery2['default'])('body');
	    this.$popup = (0, _jquery2['default'])('.js-popup');
	    this.$inner = this.$popup.find('.popup-inner');
	    this.$close = this.$popup.find('.popup-cache, .popup-close');
	  ...
	  _createClass(Popup, [{
	    ...
	    value: function events() {
	      ...
	      _jquery2['default'].each(this.$nodes, function (i, node) {
	        var $node = (0, _jquery2['default'])(node);
	        var source = $node.attr('href');
	
	        $node.on('click touchstart', function (event) {
	          event.preventDefault();
	          event.stopPropagation();
	          ...
	          _jquery2['default'].ajax({
	            ...
	            success: function success(response) {
	              var $content = (0, _jquery2['default'])(response).find('.js-popup-content');
	
	              // Inject content
	              _this.inject($content.html());
	      ...
	      // Close enabled
	      this.$close.on('click touchstart', function (event) {
	        event.preventDefault();
	        event.stopPropagation();
	    ...
	    value: function open() {
	      ...
	      // Disable body scroll
	      this.$body.addClass('is-popup-open');
	    }
	  }, {
	    key: 'close',
	    value: function close() {
	      ...
	      // Enable body scroll
	      this.$body.removeClass('is-popup-open');
	      ...
	      setTimeout(function () {
	        _this2.$popup.removeClass('is-hidden');
	        _this2.$inner.empty();
	
	        if (_this2.$inner.hasClass('has-video')) {
	          _this2.$inner.removeClass('has-video');
	        }
	      }, 800);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonEventEmitter = __webpack_require__(39);
	
	var _commonEventEmitter2 = _interopRequireDefault(_commonEventEmitter);
	
	// Events name declaration
	var NAVIGATE_START = 'navigatestart';
	var NAVIGATE_END = 'navigateend';
	var NAVIGATE_ERROR = 'navigateerror';
	...
	// Cached regex for stripping base url
	var baseUrlStripper = /^https?:\/\/[a-z\:0-9.\-]+/;
	...
	var Router = (function (_EventEmitter) {
	  ...
	  function Router(options) {
	    ...
	    this._cache = {};
	    this._cacheMaxAge = this.options.cacheMaxAge;
	    ...
	    if (this._wantsHashChange && this._wantsPushState) {
	      ...
	      if (!this._hasPushState && !this.atRoot()) {
	        ...
	        window.location.replace(root + '#' + this.getPath());
	  ...
	  _createClass(Router, [{
	    ...
	    key: 'removeBaseUrl',
	    value: function removeBaseUrl(url) {
	      var result = '';
	
	      var match = baseUrlStripper.exec(url);
	      if (match) {
	        result = match[0];
	      }
	    ...
	    value: function getPath() {
	      var path = this.decodeFragment(window.location.pathname + this.getSearch()).slice(this.root.length - 1);
	      return path.charAt(0) === '/' ? path.slice(1) : path;
	    }
	
	    /**
	     * Get the cross-browser normalized URL fragment from the path
	     * @param  {String} fragment
	     * @return {String}
	     */
	  }, {
	     ...
	     * calls `navigate`
	     * @param  {Event} event [onpopstate event]
	     */
	  }, {
	    key: 'checkUrl',
	    value: function checkUrl() {
	      ...
	      this.navigate(current, { popstate: true });
	    }
	
	    /**
	     * Cache the ajax response with a current timestamp in seconds
	     * @param  {String} content
	     * @return {Object}
	     */
	  }, {
	    key: 'cache',
	    value: function cache(content) {
	    ...
	    /**
	     * Retrieve teh content from a given fragment.
	     * Check if the cache exists and if it has expired or not.
	     * @param  {String} fragment
	     * @return {Boolean}
	     */
	  }, {
	    key: 'fromCache',
	    value: function fromCache(fragment) {
	      // Check if the fragment exists in the cache store
	      if (!(fragment in this._cache)) return false;
	
	      // Check if the cache has expire
	      var now = Date.now() / 1000 | 0;
	      var createdAt = this._cache[fragment].createdAt;
	      var diff = now - createdAt;
	
	      // If has expires, remove from cache store
	      if (diff > this._cacheMaxAge) {
	        delete this._cache[fragment];
	        return false;
	      }
	     ...
	     * Try to retrieve the content from cache otherwise fetch the url.
	     * @param  {String} fragment [url to navigate to]
	    ...
	    value: function navigate(fragment) {
	      ...
	      var options = arguments.length <= 1 || arguments[1] === undefined ? { popstate: false } : arguments[1];
	
	      // Came from popstate or not
	      this.popstate = options.popstate;
	      this.replace = options.replace;
	
	      // Remove base url
	      fragment = this.removeBaseUrl(fragment || '');
	      ...
	      this.trigger(Router.NAVIGATE_START);
	
	      if (this.fromCache(this.fragment)) {
	    ...
	    /**
	     * Fetch the content by making an ajax request on the given url.
	    ...
	    value: function fetch(url) {
	      ...
	      if (this._ajaxRequest && this._ajaxRequest !== 4) {
	        this._ajaxRequest.abort();
	      }
	
	      this._ajaxRequest = _jquery2['default'].ajax({
	        url: url,
	        success: function success(response) {
	        ...
	        error: function error(xhr, textStatus, errorThrown) {
	          _this2.trigger(Router.NAVIGATE_START, xhr.status, errorThrown);
	        }
	      });
	    }
	    ...
	    key: 'fetched',
	    value: function fetched(url) {
	      var html = this._cache[this.fragment].content;
	
	      // If pushState is available, we use it to set the fragment as a real URL.
	      if (this._usePushState === true && this.popstate === false) {
	        window.history[this.replace ? 'replaceState' : 'pushState']({}, null, url);
	        // If hash changes haven't been explicitly disabled, update the hash
	        // fragment to store history.
	      } else if (this._wantsHashChange) {
	          this._updateHash(this.fragment, this.replace);
	        }
	
	      // Change document title
	      var title = this.decodeHTML(html.match(/<title>(.*?)<\/title>/)[1].trim());
	      document.title = title;
	
				this.trigger(Router.NAVIGATE_END, html, title);
				document.dispatchEvent(new Event('app:navigation_end'));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaults = {
	  group: '.js-search-input',
	  trigger: '.js-search-input-trigger',
	  open: 'is-open'
	};
	...
	var SearchInput = (function () {
	  ...
	  _createClass(SearchInput, [{
	    ...
	    value: function init() {
	      ...
	      this.isOpen = this.$trigger.hasClass('is-open');
	    }
	  }, {
	    key: 'initEvents',
	    value: function initEvents() {
	      this.$trigger.on('click', this.triggerClicked.bind(this));
	      this.$input.on('keypress', this.keyPressed.bind(this));
	    }
	  }, {
	    key: 'keyPressed',
	    value: function keyPressed(event) {
	      if (event.which == 13) {
	        this.$group.closest('form').submit();
	      }
	    }
	  }, {
	    key: 'triggerClicked',
	    value: function triggerClicked(event) {
	      this.$group.toggleClass(defaults.open);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formstoneDistJsEqualize = __webpack_require__(18);
	
	var _formstoneDistJsEqualize2 = _interopRequireDefault(_formstoneDistJsEqualize);
	
	var _componentsGraph = __webpack_require__(45);
	...
	var TimelineSlider = (function () {
	  function TimelineSlider() {
	    ...
	    this.$timeline = $('.js-timeline-slider');
	    ...
	    this.$timeline.equalize();
	    this.$timeline.carousel();
	    this.graph = new _componentsGraph2['default']();
	    this.$timeline.on('update.carousel', this.carouselUpdate.bind(this));
	    $(window).on('keyup', this.keyup.bind(this));
	  }
	
	  _createClass(TimelineSlider, [{
	    key: 'carouselUpdate',
	    value: function carouselUpdate(event, index) {
	      if (this.currentSlideIndex < index) {
	        this.graph.shiftLeft();
	      } else {
	        this.graph.shiftRight();
	      }
	    ...
	    value: function keyup(event) {
	      ...
	      if (event.keyCode == 37) {
	        this.$timeline.carousel('previous');
	      }
	      if (event.keyCode == 39) {
	        this.$timeline.carousel('next');
	      }
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaults = {
	  ...
	  headerMenuMobileTrigger: '.js-header-menu-mobile-trigger',
	  subMenuTrigger: '.js-sub-menu-trigger',
	  headerTransparent: 'header--transparent',
	  headerBlack: 'header--black',
	  menuBlack: 'menu--black',
	  menuWhite: 'menu--white',
	  hovered: 'is-hovered'
	};
	...
	var Header = (function () {
	  ...
	  _createClass(Header, [{
	    key: 'init',
	    value: function init() {
	      this.$header = (0, _jquery2['default'])(defaults.header);
	      this.headerHeight = this.$header.height();
	      this.captureInnerElements();
	      this.transparent = this.isHeaderTransparent(this.$header);
	      this.lastScrollTop = window.W.scrollTop;
	      this.hoverTimeout = null;
	
	      this.onEnterFrame();
	    }
	  }, {
	    key: 'captureInnerElements',
	    value: function captureInnerElements() {
	      this.$headerMenu = (0, _jquery2['default'])(defaults.headerMenu);
	      this.$subMenuTrigger = (0, _jquery2['default'])(defaults.subMenuTrigger);
	    }
	  }, {
	    key: 'initEvents',
	    value: function initEvents() {
	      (0, _jquery2['default'])(defaults.headerMenuMobileTrigger).on('click', this.mobileMenuToggle.bind(this));
	      if (window.W.width < 1000) {
	        (0, _jquery2['default'])(defaults.header).on('click', '.js-sub-menu-trigger > a, .js-sub-menu-trigger > span', this.mobileSubMenuToggle.bind(this));
	        (0, _jquery2['default'])('.js-header-submenu-mobile-close').on('click', this.mobileSubMenuClose.bind(this));
	      } else {
	        this.$header.on('mouseenter', defaults.subMenuTrigger, this.subMenuTriggerHoverIn.bind(this));
	        this.$header.on('mouseleave', defaults.subMenuTrigger, this.subMenuTriggerHoverOut.bind(this));
	      }
	    }
	  }, {
	    key: 'unbindEvents',
	    value: function unbindEvents() {
	      (0, _jquery2['default'])(defaults.headerMenuMobileTrigger).off('click', this.mobileMenuToggle.bind(this));
	      (0, _jquery2['default'])(defaults.subMenuTrigger).unbind('mouseenter mouseleave');
	    }
	  }, {
	    key: 'isHeaderTransparent',
	    value: function isHeaderTransparent($header) {
	      return $header.hasClass(defaults.headerTransparent);
	    }
	  }, {
	    key: 'mobileMenuToggle',
	    value: function mobileMenuToggle(event) {
	      if ((0, _jquery2['default'])('html').hasClass('is-header-submenu-open')) {
	        (0, _jquery2['default'])('.sub-menu').scrollTop(0);
	        (0, _jquery2['default'])(defaults.subMenuTrigger).removeClass(defaults.hovered);
	        (0, _jquery2['default'])('html').removeClass('is-header-submenu-open');
	      }
	
	      (0, _jquery2['default'])('html').toggleClass('is-header-menu-open');
	
	      return false;
	    }
	  }, {
	    key: 'mobileSubMenuToggle',
	    value: function mobileSubMenuToggle(event) {
	      if ((0, _jquery2['default'])('html').hasClass('is-header-menu-open')) {
	        event.preventDefault();
	        event.stopImmediatePropagation();
	
	        var $currentSubMenu = (0, _jquery2['default'])(event.currentTarget).parent();
	
	        if ($currentSubMenu.hasClass(defaults.hovered)) {
	          this.$subMenuTrigger.removeClass(defaults.hovered);
	          (0, _jquery2['default'])('html').removeClass('is-header-submenu-open');
	        } else {
	          $currentSubMenu.addClass(defaults.hovered);
	          (0, _jquery2['default'])('html').addClass('is-header-submenu-open');
	        }
	    ...
	    key: 'mobileSubMenuClose',
	    value: function mobileSubMenuClose(event) {
	      (0, _jquery2['default'])('.sub-menu').scrollTop(0);
	      (0, _jquery2['default'])(defaults.subMenuTrigger).removeClass(defaults.hovered);
	      (0, _jquery2['default'])('html').removeClass('is-header-submenu-open');
	    ...
	    key: 'subMenuTriggerHoverIn',
	    value: function subMenuTriggerHoverIn(event) {
	      if (this.hoverTimeout) {
	        clearTimeout(this.hoverTimeout);
	      }
	      var $currentSubMenu = (0, _jquery2['default'])(event.currentTarget);
	      if (this.transparent) {
	        this.$header.addClass(defaults.headerBlack);
	      }
	      this.$header.addClass(defaults.hovered);
	      this.$subMenuTrigger.removeClass(defaults.hovered);
	      $currentSubMenu.addClass(defaults.hovered);
	    }
	  }, {
	    key: 'subMenuTriggerHoverOut',
	    value: function subMenuTriggerHoverOut() {
	      var _this = this;
	
	      this.hoverTimeout = setTimeout(function () {
	        if (_this.transparent) {
	          _this.$header.removeClass(defaults.headerBlack);
	        }
	        _this.$header.removeClass(defaults.hovered);
	        _this.$subMenuTrigger.removeClass(defaults.hovered);
	      }, 250);
	    }
	  }, {
	    key: 'openSubMenu',
	    value: function openSubMenu() {
	      ...
	      this.$header.addClass(defaults.hovered);
	      this.$subMenuTrigger.addClass(defaults.hovered);
	    }
	  }, {
	    key: 'closeSubMenu',
	    value: function closeSubMenu() {
	      if (this.transparent) {
	        this.$header.removeClass(defaults.headerBlack);
	      }
	      this.$header.removeClass(defaults.hovered);
	      this.$subMenuTrigger.removeClass(defaults.hovered);
	    }
	  }, {
	    key: 'refresh',
	    value: function refresh($newHeader) {
	      var $newHeaderMenu = $newHeader.find(defaults.headerMenu);
	
	      this.$header.attr('class', $newHeader.attr('class'));
	      this.transparent = this.isHeaderTransparent($newHeader);
	      if (this.transparent) {
	        this.$headerMenu.removeClass(defaults.menuBlack);
	        this.$headerMenu.addClass(defaults.menuWhite);
	      } else {
	        this.$headerMenu.removeClass(defaults.menuWhite);
	        this.$headerMenu.addClass(defaults.menuBlack);
	      }
	      this.$headerMenu.html($newHeaderMenu.html());
	      this.captureInnerElements();
	      this.subMenuTriggerHoverOut();
	    }
	  }, {
	    key: 'onEnterFrame',
	    value: function onEnterFrame() {
	      ...
	      var scrollTop = window.W.scrollTop;
	
	      if (scrollTop > this.headerHeight) {
	        if (Math.abs(this.lastScrollTop - scrollTop) <= 0) return;
	
	        if (scrollTop > this.lastScrollTop) {
	          // down
	          this.$header.addClass('is-hidden');
	          setTimeout(function () {
	            _this2.$header.addClass('is-fixed');
	          }, 400);
	        } else {
	          // up
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonBaseView = __webpack_require__(38);
	
	var _commonBaseView2 = _interopRequireDefault(_commonBaseView);
	
	var _componentsRouter = __webpack_require__(50);
	
	var _componentsRouter2 = _interopRequireDefault(_componentsRouter);
	
	var _isMobileIsMobile = __webpack_require__(37);
	
	var _isMobileIsMobile2 = _interopRequireDefault(_isMobileIsMobile);
	
	//import SmoothScroll from 'components/smooth-scroll';
	
	var _componentsAnimateScroll = __webpack_require__(42);
	
	var _componentsAnimateScroll2 = _interopRequireDefault(_componentsAnimateScroll);
	
	// Layout classes
	
	var _layoutHeader = __webpack_require__(54);
	
	var _layoutHeader2 = _interopRequireDefault(_layoutHeader);
	
	var _layoutFooter = __webpack_require__(53);
	
	var _layoutFooter2 = _interopRequireDefault(_layoutFooter);
	
	// Template classes
	
	var _defaultView = __webpack_require__(56);
	...
	var App = (function (_BaseView) {
	  _inherits(App, _BaseView);
	  ...
	  function App() {
	    ...
	    this.events = {
	      ...
	      'click [data-internal-link] a': 'stopNavigatePropagation',
	      'click [data-href]': 'navigate',
	      'click [data-href] a': 'stopNavigatePropagation',
	      'click [data-goto-hash]': 'gotoHashClicked'
	    };
	
	    // Init app router
	    this.isNavigating = false;
	
	    this.Router = new _componentsRouter2['default']({ hashChange: false, pushState: true });
	    this.Router.on(_componentsRouter2['default'].NAVIGATE_START, this.onNavigateStart.bind(this));
	    this.Router.on(_componentsRouter2['default'].NAVIGATE_END, this.onNavigateEnd.bind(this));
	    this.Router.on(_componentsRouter2['default'].NAVIGATE_ERROR, this.onNavigateError.bind(this));
	
	    // Define variables
	    this.appContainer = $('.js-app-container');
	    this.appHeader = $('.js-app-header');
	    this.appFooter = $('.js-app-footer');
	    this.appTemplate = this.appContainer.attr('id');
	  ...
	  _createClass(App, [{
	    key: '_initClass',
	    value: function _initClass() {
	      // Instanciate components classes
	      if (this.appHeader && this.appHeader.length !== 0) {
	        this.appHeaderClass = new _layoutHeader2['default']();
	      }
	
	      if (this.appFooter && this.appFooter.length !== 0) {
	        this.appFooterClass = new _layoutFooter2['default']();
	      }
	
	      // Save app class
	      if (this.appContainer && this.appContainer.length !== 0) {
	        this.appClass = this._getAppClass();
	      }
	
	      // Init smooth scroll
	      if (!_isMobileIsMobile2['default'].any) {
	        // this.smoothScroll = new SmoothScroll($('.js-smooth-scroll'));
	      }
	      this.animateScroll = new _componentsAnimateScroll2['default']();
	
	      this.gotoLocationHash();
	    }
	
	    /**
	     * Get current app class
	     * @return {Object} class
	     * @private
	     */
	  }, {
	    key: '_getAppClass',
	    value: function _getAppClass() {
	      if (this.appTemplate) {
	        // Define class name
	        var className = this._capitalizeFirstLetter(this.appTemplate);
	        // Instanciate class
	        return new TEMPLATES[className]();
	      } else {
	        return new _defaultView2['default']();
	      }
	    }
	    ...
	    value: function _capitalizeFirstLetter(string) {
	      ...
	      var leftLetters = string.slice(1);
	    ...
	    value: function navigate(event) {
	      ...
	      var exceptions = ['find-a-doctor'];
	      var parse = function parse(array) {
	    ...
	    value: function stopNavigatePropagation(event) {
	      event.stopPropagation();
	    }
	    ...
	    key: 'onNavigateStart',
	    value: function onNavigateStart() {
	      this.isNavigating = true;
	      $('html').removeClass('is-header-menu-open is-header-submenu-open');
	    }
	    ...
	    key: 'onNavigateEnd',
	    value: function onNavigateEnd(html) {
	      var _this = this;
	
	      var $newHtml = $(html);
	      var content = $newHtml.find('.js-app-container');
	      var header = $newHtml.find('.js-app-header');
	      var footer = $newHtml.find('.js-app-footer');
	
	      this.appHeaderClass.refresh(header);
	
	      this.appFooter.velocity({ opacity: 0 }, {
	        duration: 500,
	        ease: 'easeOutQuad',
	        complete: function complete() {
	          _this.appFooter.replaceWith(footer);
	          _this.appFooter = footer;
	
	          _this.appFooter.css({ opacity: 0 }).velocity({ opacity: 1 }, {
	            duration: 500,
	            ease: 'easeOutQuad'
	          });
	        }
	      ...
	      this.appContainer.velocity({ opacity: 0 }, {
	        duration: 500,
	        ease: 'easeOutQuad',
	        complete: function complete() {
	          _this.appContainer.replaceWith(content);
	          _this.appContainer = content;
	
	          _this.appClass && _this.appClass.destroy();
	          _this.appClass = null;
	
	          //this.smoothScroll && this.smoothScroll.destroy();
	          _this.animateScroll && _this.animateScroll.destroy();
	
	          _this.appTemplate = _this.appContainer.attr('id');
	
	          _this.$document.scrollTop(0);
	
	          _this.appContainer.css({ opacity: 0 }).velocity({ opacity: 1 }, {
	            duration: 500,
	            ease: 'easeOutQuad',
	            complete: function complete() {
	              if (_this.appContainer && _this.appContainer.length !== 0) {
	                // Save app class
	                _this.appClass = _this._getAppClass();
	              }
	              ...
	              _this.animateScroll = new _componentsAnimateScroll2['default']();
	
	              _this.isNavigating = false;
	              _this.gotoLocationHash();
	            }
	          });
	        }
	      });
	    ...
	    key: 'onNavigateError',
	    value: function onNavigateError(status, error) {
	      console.log('error', status, error);
	    }
	  }, {
	    key: 'gotoHashClicked',
	    value: function gotoHashClicked(event) {
	      event.preventDefault();
	      var $target = $(event.currentTarget);
	      var href = $target.attr('href');
	
	      if (href.length) {
	        this.gotoHash(href.substring(href.indexOf('#')));
	      }
	    }
	
	    /**
	     * Move to url hash if found
	     */
	
	  }, {
	    key: 'gotoLocationHash',
	    value: function gotoLocationHash() {
	      if (location.hash) {
	    ...
	    value: function gotoHash(hash) {
	      ...
	      if ($hashElement.length) {
	        $hashElement.velocity("scroll", { duration: 500, easing: 'easeOutQuad', offset: -100 });
	      }
	    }
	  }]);
	
	  return App;
	})(_commonBaseView2['default']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formstoneDistJsDropdown = __webpack_require__(34);
	
	var _formstoneDistJsDropdown2 = _interopRequireDefault(_formstoneDistJsDropdown);
	
	var _componentsTimelineSlider = __webpack_require__(52);
	
	var _componentsTimelineSlider2 = _interopRequireDefault(_componentsTimelineSlider);
	
	var _componentsHeroSlider = __webpack_require__(46);
	
	var _componentsHeroSlider2 = _interopRequireDefault(_componentsHeroSlider);
	
	var _componentsAccordion = __webpack_require__(41);
	
	var _componentsAccordion2 = _interopRequireDefault(_componentsAccordion);
	
	var _componentsSearchInput = __webpack_require__(51);
	
	var _componentsSearchInput2 = _interopRequireDefault(_componentsSearchInput);
	
	var _componentsFocus = __webpack_require__(44);
	
	var _componentsFocus2 = _interopRequireDefault(_componentsFocus);
	
	var _componentsMediaLightbox = __webpack_require__(47);
	
	var _componentsMediaLightbox2 = _interopRequireDefault(_componentsMediaLightbox);
	
	var _componentsPasswordProtected = __webpack_require__(48);
	
	var _componentsPasswordProtected2 = _interopRequireDefault(_componentsPasswordProtected);
	
	var _componentsCustomDropdown = __webpack_require__(43);
	
	var _componentsCustomDropdown2 = _interopRequireDefault(_componentsCustomDropdown);
	
	var _componentsPopup = __webpack_require__(49);
	...
	var DefaultView = (function () {
	  function DefaultView() {
	    ...
	    this.Popup = new _componentsPopup2['default']();
	  }
	
	  _createClass(DefaultView, [{
	    key: 'equalize',
	    value: function equalize() {
	      (0, _jquery2['default'])('.js-equalize').equalize();
	    }
	  }, {
	    key: 'increment',
	    value: function increment() {
	      var $nodes = (0, _jquery2['default'])('[data-increment-url]');
	
	      _jquery2['default'].each($nodes, function (i, node) {
	        var $node = (0, _jquery2['default'])(node);
	        var url = $node.data('increment-url');
	        ...
	        $node.on('click touchstart', function (event) {
	          ...
	          _jquery2['default'].post(url, {}, function (response) {
	            window.open(href);
	          });
	        });
	      });
	    ...
	    value: function video() {
	      ...
	      var $nodes = (0, _jquery2['default'])('[data-popup-video]');
	      var $frame = (0, _jquery2['default'])('<iframe src="" width="100%" height="545" frameborder="0"></iframe>');
	
	      _jquery2['default'].each($nodes, function (i, node) {
	        var $node = (0, _jquery2['default'])(node);
	        var source = $node.data('popup-video');
	
	        var rewrite = function rewrite(string) {
	          if (string.indexOf('?') === -1) return string + '?autoplay=1';else return string + '&autoplay=1';
	        };
	        ...
	        $node.on('click touchstart', function (event) {
	          ...
	          // Update frame source
	          $frame.attr('src', rewrite(source));
	
	          // Open popup
	          _this.Popup.inject($frame);
	          _this.Popup.$inner.addClass('has-video');
	          _this.Popup.open();
	        });
	      });
	    }
	    ...
	    value: function dropdown() {
	      new _componentsCustomDropdown2['default']();
	    ...
	    value: function heroSlider() {
	      this.HeroSlider = new _componentsHeroSlider2['default']();
	    }
	  }, {
	    key: 'timelineSlider',
	    value: function timelineSlider() {
	      new _componentsTimelineSlider2['default']();
	    }
	  }, {
	    key: 'accordion',
	    value: function accordion() {
	      new _componentsAccordion2['default']();
	    }
	  }, {
	    key: 'searchInput',
	    value: function searchInput() {
	      new _componentsSearchInput2['default']();
	    }
	  }, {
	    key: 'destroy',
	    value: function destroy() {
	    ...
	    value: function focus() {
	      new _componentsFocus2['default']();
	    }
	  }, {
	    key: 'mediaLightbox',
	    value: function mediaLightbox() {
	      new _componentsMediaLightbox2['default']();
	    }
	  }, {
	    key: 'passwordProtected',
	    value: function passwordProtected() {
	      new _componentsPasswordProtected2['default']();
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(__webpack_provided_window_dot_jQuery, jQuery) {/*** IMPORTS FROM imports-loader ***/
	(function() {
...
/* Custom code for Getting Recaptcha token after Router navigate event */

(function() {
	var initRecaptcha = function() {
		var form = document.getElementById('contact-form');
		if (form) {
			var recaptchaElement = form.querySelector('#recaptcha-contact-input');
			var recaptchaKey = form.getAttribute('data-recaptcha-key');

			if (recaptchaElement && recaptchaKey) {
	...
	document.addEventListener('app:navigation_end', function() {
